                                        ...
                                        children: [
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              '65kjn6ni' /* It's time for you to level up! */,
                                            ),
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '0ob65ef3' /* Gain Emotional Control */,
                                              ),
                                              textAlign: TextAlign.center,
                                              style:
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'gqbgq17v' /* Build new habits and remove ba... */,
                                              ),
                                              textAlign: TextAlign.center,
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'pw53ptwz' /* You can see your daily and wee... */,
                                              ),
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
