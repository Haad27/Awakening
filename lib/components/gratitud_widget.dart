...
import 'gratitud_model.dart';
export 'gratitud_model.dart';

class GratitudWidget extends StatefulWidget {
  const GratitudWidget({super.key});
...
class _GratitudWidgetState extends State<GratitudWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GratitudModel());
        ...
        children: [
          ...
          Padding(
            ...
            child: FFButtonWidget(
              onPressed: () async {
                await GratitudeRecord.createDoc(currentUserReference!)
                    .set(createGratitudeRecordData(
